...
Portfolio
|-- assets 
|   |-- images      # certificates, awards, photos, CV (pdf)
|   |-- styles      # css styles
|-- components      # 12 page-section files
|-- js              # javascript for interactivity/scripts
|-- page            # main page that combines all page-section files 